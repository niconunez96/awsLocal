...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  function_name = module.unsubscription_survey_saver.unsubscription_survey_lambda_name
...
resource "aws_api_gateway_integration" "save_unsubscription_survey_integration" {
  ...
  type                    = "AWS_PROXY"
  uri                     = module.unsubscription_survey_saver.unsubscription_survey_lambda_arn
}
